# Generated by Django 3.1.4 on 2020-12-07 07:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Account_ID', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('Membership_ID', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='authentication.membership')),
            ],
        ),
    ]
